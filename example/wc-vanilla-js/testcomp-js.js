...
const dispatch = () => {
    console.log('JavaScript-komponent: Dispatch js:clicked');
...
class WebComponent extends HTMLElement {
    connectedCallback() {
        ...
        console.log('JavaScript-komponent: Lytter etter events...');
    }

    handleEvent() {
        console.log('JavaScript-komponent: Event mottatt: react:clicked');
